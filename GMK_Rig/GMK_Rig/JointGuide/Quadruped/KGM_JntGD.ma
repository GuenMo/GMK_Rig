...
//Name: KGM_JntGD.ma
//Last modified: Fri, Aug 22, 2014 08:00:16 PM
//Codeset: 949
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.11699558988089553 2.904959505688038 8.9502784394767829 ;
	setAttr ".r" -type "double3" -11.13835272981339 -354.99999999982185 -9.9771996363915905e-017 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 8.0376522149624652;
...
createNode transform -n "ChestJntGDLoc" -p "SpineGDSys";
	setAttr ".t" -type "double3" 0 4.3385160710970991 -0.024604144734269875 ;
	setAttr ".it" no;
