...
//Name: KGM_JntGD.ma
//Last modified: Fri, Aug 29, 2014 07:09:26 PM
//Codeset: 949
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.336563247946863 2.9363110670769905 1.7936041240750993 ;
	setAttr ".r" -type "double3" -3.3383527298491531 -265.40000000023099 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 12.79370224593673;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.64794625007612316 2.0590135238587464 100.12143622027575 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 13.290398658359619;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.55627659612389 0.85433138539003595 2.0652770221306982 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 6.9873369536817185;
...
createNode transform -n "JntGDCtrl" -p "AllJntGDGrp";
	...
	setAttr ".t" -type "double3" 0 2.2782081787757664 -3.0004676442065263 ;
	setAttr -l on ".tx";
...
createNode joint -n "LeftAnkleJntGD" -p "JntGDGrp";
	setAttr -l on ".v";
	setAttr ".ove" yes;
	setAttr ".r" -type "double3" -179.99996384707703 0 -89.999985677002741 ;
	setAttr -l on ".ry";
	setAttr -l on ".rz";
	setAttr -l on ".sx";
	setAttr -l on ".sy";
...
createNode joint -n "LeftBallJntGD" -p "LeftAnkleJntGD";
	setAttr -l on ".v";
	setAttr ".t" -type "double3" -0.32102546146412109 -1.5546070518002947e-006 -0.77682413859168853 ;
	setAttr ".r" -type "double3" 89.999999999999986 7.9513867036587919e-016 180 ;
	setAttr -l on ".sx";
	setAttr -l on ".sy";
	setAttr -l on ".sz";
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
...
createNode orientConstraint -n "LeftAnkleJntGD_orientConstraint1" -p "LeftAnkleJntGD";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".lr" -type "double3" -180 -68.387612450334473 90 ;
...
createNode joint -n "LeftClavicleJntGD" -p "JntGDGrp";
	setAttr -l on ".v";
	setAttr ".t" -type "double3" 1.8507460020484883 14.590369302869791 0.44507420334720588 ;
	setAttr ".r" -type "double3" 8.9419408677555375e-014 83.874485186057683 89.999999999997499 ;
	setAttr -l on ".sx";
	setAttr -l on ".sy";
	setAttr -l on ".sz";
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
...
createNode joint -n "LeftShoulderJntGD" -p "LeftClavicleJntGD";
	setAttr -l on ".v";
	setAttr ".t" -type "double3" 0.7520772665278278 -8.8817841970012523e-016 -2.7610131682735413e-030 ;
	setAttr -l on ".sx";
	setAttr -l on ".sy";
	setAttr -l on ".sz";
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
...
createNode joint -n "LeftElbowJntGD" -p "LeftShoulderJntGD";
	...
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr ".r" -type "double3" 0 22.321212950680593 0 ;
	setAttr -l on ".rx";
	setAttr -l on ".rz";
	setAttr -l on ".sx";
	setAttr -l on ".sy";
...
createNode joint -n "LeftWristJntGD" -p "LeftElbowJntGD";
	setAttr -l on ".v";
	setAttr ".t" -type "double3" 3.4128286539055757 0 0 ;
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr ".r" -type "double3" 90.000000000000327 74.010748952866479 1.1546464681365161e-014 ;
	setAttr -l on ".sx";
	setAttr -l on ".sy";
	setAttr -l on ".sz";
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
...
createNode parentConstraint -n "Neck1JntGD_parentConstraint1" -p "Neck1JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -89.999999999999957 7.016709298534876e-015 
		89.999999999999972 ;
	setAttr ".lr" -type "double3" -89.999999999999929 -3.9756933518293952e-015 -10.362543422654305 ;
...
createNode parentConstraint -n "HeadEndJntGD_parentConstraint1" -p "HeadEndJntGD";
	...
	setAttr ".lr" -type "double3" -4.9360717771306858e-014 4.062661643900687e-015 5.0888874903416281e-014 ;
...
createNode parentConstraint -n "LeftEyeJntGD_parentConstraint1" -p "LeftEyeJntGD";
	...
	setAttr ".lr" -type "double3" 4.0638094425690803e-015 -4.8644330576317592e-014 -5.0888874903416268e-014 ;
...
createNode parentConstraint -n "HeadJntGD_parentConstraint1" -p "HeadJntGD";
	...
	setAttr ".lr" -type "double3" -180.02872416567575 48.228701422342361 -0.064170546023138986 ;
...
createNode parentConstraint -n "Spine4JntGD_parentConstraint1" -p "Spine4JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -3.2461146750243012e-014 7.0167092985348775e-015 
		89.999999999999972 ;
	setAttr ".lr" -type "double3" -89.999999999999957 -2.7528138084907621 6.9655013518171015e-015 ;
...
createNode parentConstraint -n "Spine3JntGD_parentConstraint1" -p "Spine3JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" 89.999999999999957 7.0167092985348791e-015 
		89.999999999999972 ;
	setAttr ".lr" -type "double3" -180.00000000000003 -177.90303721237674 180 ;
...
createNode parentConstraint -n "Spine2JntGD_parentConstraint1" -p "Spine2JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -90.000000000000071 -1.4124500153760516e-030 
		89.999999999999986 ;
	setAttr ".lr" -type "double3" -4.4533232060199843e-014 -1.6674890284569346 5.1657792700550001e-017 ;
...
createNode parentConstraint -n "Spine1JntGD_parentConstraint1" -p "Spine1JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -90.000000000000071 2.7855664942724593e-061 
		89.999999999999986 ;
	setAttr ".lr" -type "double3" -4.4530086843205808e-014 -1.3589290362668294 -6.8293647570784938e-017 ;
...
createNode parentConstraint -n "RootJntGD_parentConstraint1" -p "RootJntGD";
	...
	setAttr ".lr" -type "double3" -3.0585856173824396e-014 3.8300261769514563 -2.0116652780917805e-014 ;
...
createNode joint -n "RightAnkleJntGD" -p "RightFoot";
	setAttr -l on ".v";
	setAttr ".r" -type "double3" 180.00003615843002 0 -89.999985677002741 ;
	setAttr -l on ".ry";
	setAttr -l on ".rz";
	setAttr -l on ".sx";
	setAttr -l on ".sy";
...
createNode orientConstraint -n "RightAnkleJntGD_orientConstraint1" -p "RightAnkleJntGD";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".lr" -type "double3" 180 -68.387612450334444 90 ;
...
createNode parentConstraint -n "RightToeJntGD_parentConstraint1" -p "RightToeJntGD";
	...
	setAttr ".lr" -type "double3" -179.99999999998738 180 -5.5070413754229983e-009 ;
...
createNode parentConstraint -n "RightFootInJntGD_parentConstraint1" -p "RightFootInJntGD";
	...
	setAttr ".lr" -type "double3" -179.99999999998738 180 2.864048751569093e-005 ;
...
createNode parentConstraint -n "conGrp_parentConstraint1" -p "conGrp";
	...
	setAttr ".lr" -type "double3" 180 270.0000000055071 0 ;
...
createNode joint -n "LeftHipJntGD" -p "transform1";
	setAttr -l on ".v";
	setAttr ".t" -type "double3" 1.7349990246206461 9.0000042158112219 -0.17872228065920767 ;
	setAttr ".r" -type "double3" 0 -111.61238754966553 0 ;
	setAttr -l on ".sx";
	setAttr -l on ".sy";
	setAttr -l on ".sz";
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
...
createNode joint -n "LeftKneeJntGD" -p "LeftHipJntGD";
	...
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr ".r" -type "double3" 0 39.199644702627644 0 ;
	setAttr -l on ".sx";
	setAttr -l on ".sy";
	setAttr -l on ".sz";
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
...
createNode joint -n "LeftAnkleScaleFixJntGD" -p "LeftKneeJntGD";
	setAttr -l on ".v";
	setAttr ".t" -type "double3" 2.5882549108952508 -8.8817841970012484e-016 0 ;
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr -l on ".rx";
	setAttr -l on ".ry";
...
createNode parentConstraint -n "RightAnkleScaleFixJntGD_parentConstraint1" -p "RightAnkleScaleFixJntGD";
	...
	setAttr ".tg[0].tor" -type "double3" 1.4073564998032058e-014 -7.1255561769939198e-015 
		90.000000000000057 ;
	setAttr ".lr" -type "double3" 180 180 179.99999999999997 ;
...
createNode parentConstraint -n "RightKneeJntGD_parentConstraint1" -p "RightKneeJntGD";
	...
	setAttr ".tg[0].tor" -type "double3" 1.4073564998032053e-014 -2.8805439864443528e-015 
		90.000000000000057 ;
	setAttr ".lr" -type "double3" 180.00000000000006 140.80035529737233 180.00000000000011 ;
...
createNode parentConstraint -n "RightHipJntGD_parentConstraint1" -p "RightHipJntGD";
	...
	setAttr ".tg[0].tor" -type "double3" 1.4075708796659011e-014 -0.99999999999999978 
		90.000000000000057 ;
	setAttr ".lr" -type "double3" 1.526666247102488e-013 248.38761245033447 -2.0355549961366507e-013 ;
...
createNode parentConstraint -n "RightWristJntGD_parentConstraint1" -p "RightWristJntGD";
	...
	setAttr ".lr" -type "double3" -90.000000000041368 -254.01074895286825 179.99999999994643 ;
...
createNode parentConstraint -n "RightElbowJntGD_parentConstraint1" -p "RightElbowJntGD";
	...
	setAttr ".tg[0].tor" -type "double3" 179.92902328322265 -0.94270338006361087 -179.99884180177278 ;
	setAttr ".lr" -type "double3" 179.99999999999906 157.67878704931942 -180.00000000000514 ;
...
createNode parentConstraint -n "RightShoulderJntGD_parentConstraint1" -p "RightShoulderJntGD";
	...
	setAttr ".lr" -type "double3" 180.00000000000003 180.00000000000003 -180.00000000000006 ;
...
createNode parentConstraint -n "RightClavicleJntGD_parentConstraint1" -p "RightClavicleJntGD";
	...
	setAttr ".lr" -type "double3" 180.00000000003223 96.125514813931176 -89.999999999983515 ;
...
createNode transform -n "ChestJntGDLoc" -p "SpineGDSys";
	setAttr ".t" -type "double3" 0 2.2484209430594331 0.6527234427401194 ;
	setAttr ".it" no;
...
createNode transform -n "Neck1JntGDCtrl" -p "SpineGDSys";
	setAttr -l on ".v";
	setAttr ".t" -type "double3" 0 15.502403707579305 -0.29572897552344118 ;
	setAttr -l on ".tx";
	setAttr -l on ".rx";
	setAttr -l on ".ry";
	setAttr -l on ".rz";
...
createNode transform -n "spineArcCtrl" -p "spineArcCtrlGrp";
	setAttr -l on ".v";
	setAttr ".t" -type "double3" 0 0.98790012409983596 0.43235064778900212 ;
	setAttr -l on ".tx";
	setAttr -l on ".rx";
	setAttr -l on ".ry";
	setAttr -l on ".rz";
...
createNode transform -n "HeadJntGDCtrl" -p "HeadJntGDCtrlGrp";
	setAttr -l on ".v";
	setAttr ".t" -type "double3" 0 -0.38818408221114054 -1.6353840477950639 ;
	setAttr -l on ".tx";
	setAttr ".r" -type "double3" -68.416659885169963 0 0 ;
	setAttr -l on ".ry";
	setAttr -l on ".rz";
	setAttr -l on ".sx";
	setAttr -l on ".sy";
...
createNode parentConstraint -n "TongueGDCurveCtrlGrp_parentConstraint1" -p "TongueGDCurveCtrlGrp";
	...
	setAttr ".lr" -type "double3" 21.583340114830055 5.3774567735460783e-015 -1.3593452077240538e-014 ;
...
createNode parentConstraint -n "LeftFingerGDGrp_parentConstraint1" -p "LeftFingerGDGrp";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".lr" -type "double3" 90.01662956204926 -89.722585833807486 90.040666485664872 ;
...
createNode parentConstraint -n "RightFingerGDGrp_parentConstraint1" -p "RightFingerGDGrp";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".lr" -type "double3" -89.983370437505371 -270.27741416619227 269.959333514766 ;
...
createNode parentConstraint -n "RightIndex5JntGD_parentConstraint1" -p "RightIndex5JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -3.3670440179448507e-014 -38.802922552545439 
		-180 ;
	setAttr ".lr" -type "double3" -180.00000000000006 -180.00000000000003 180.00000000000003 ;
...
createNode parentConstraint -n "RightIndex4JntGD_parentConstraint1" -p "RightIndex4JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -3.4180598363985608e-014 -38.802922552545439 
		-180 ;
	setAttr ".lr" -type "double3" -179.99999999999997 -179.99999999999994 180 ;
...
createNode parentConstraint -n "RightIndex2JntGD_parentConstraint1" -p "RightIndex2JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -3.3925519271717054e-014 -38.802922552545404 
		-180 ;
	setAttr ".lr" -type "double3" -180.00000000000179 -180.00000000000003 179.99999999999349 ;
...
createNode parentConstraint -n "RightIndex1JntGD_parentConstraint1" -p "RightIndex1JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -3.4037116374584531e-014 -38.802922552545404 
		-179.99999999999997 ;
	setAttr ".lr" -type "double3" -180.0000000000052 -141.19707744745452 180.00000000000949 ;
...
createNode parentConstraint -n "RightMiddle3JntGD_parentConstraint1" -p "RightMiddle3JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -2.802841220535889e-014 -18.925083132812318 
		-180 ;
	setAttr ".lr" -type "double3" -180 -179.99999999999997 180.00000000000003 ;
...
createNode parentConstraint -n "RightMiddle2JntGD_parentConstraint1" -p "RightMiddle2JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -2.8054269810082004e-014 -18.925083132812304 
		180 ;
	setAttr ".lr" -type "double3" -179.9999999999994 -180.00000000000003 179.99999999999324 ;
...
createNode parentConstraint -n "RightMiddle1JntGD_parentConstraint1" -p "RightMiddle1JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -2.8080537852975342e-014 -18.92508313281229 
		-179.99999999999997 ;
	setAttr ".lr" -type "double3" -180.00000000000429 -161.07491686718762 180.00000000000762 ;
...
createNode parentConstraint -n "RightRing5JntGD_parentConstraint1" -p "RightRing5JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -2.6637145457256948e-014 -4.8761489492743545e-014 
		-180 ;
	setAttr ".lr" -type "double3" -180 -180.00000000000003 180.00000000000003 ;
...
createNode parentConstraint -n "RightRing3JntGD_parentConstraint1" -p "RightRing3JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -2.6637145457256954e-014 -2.0534066694754825e-014 
		-180 ;
	setAttr ".lr" -type "double3" -180 -180 180.00000000000003 ;
	setAttr ".rst" -type "double3" -0.18820000000000014 -8.8817841970012523e-016 2.7755575615628914e-017 ;
	setAttr ".rsrr" -type "double3" 3.2461146750243012e-014 360 7.0167092985348791e-015 ;
	setAttr -k on ".w0";
createNode parentConstraint -n "RightRing2JntGD_parentConstraint1" -p "RightRing2JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -2.6637145457256954e-014 -7.8118479689007559e-015 
		-180 ;
	setAttr ".lr" -type "double3" -179.99999999999747 -180 179.99999999999389 ;
...
createNode parentConstraint -n "RightRing1JntGD_parentConstraint1" -p "RightRing1JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -2.6537753123461213e-014 5.83834463390587e-014 
		-180 ;
	setAttr ".lr" -type "double3" -180.00000000000406 -179.99999999999994 180.0000000000062 ;
...
createNode parentConstraint -n "RightPinky3JntGD_parentConstraint1" -p "RightPinky3JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -2.956978111248773e-014 27.454393307232259 
		-180 ;
	setAttr ".lr" -type "double3" -180.00000000000003 -180 180.00000000000003 ;
...
createNode parentConstraint -n "RightPinky2JntGD_parentConstraint1" -p "RightPinky2JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -3.0017808099040576e-014 27.454393307232269 
		179.99999999999997 ;
	setAttr ".lr" -type "double3" -179.99999999999471 -180.00000000000003 179.99999999999579 ;
...
createNode parentConstraint -n "RightPinky1JntGD_parentConstraint1" -p "RightPinky1JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -2.9919802195732134e-014 27.454393307232277 
		180 ;
	setAttr ".lr" -type "double3" -180.0000000000046 -207.45439330723221 180.00000000000404 ;
...
createNode parentConstraint -n "RightThumb2JntGD_parentConstraint1" -p "RightThumb2JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -8.6567357493896699e-013 -88.263032023026227 
		-179.99999999999915 ;
	setAttr ".lr" -type "double3" -180.00000000000608 -179.99999999999994 179.99999999999707 ;
...
createNode parentConstraint -n "RightThumb1JntGD_parentConstraint1" -p "RightThumb1JntGD";
	...
	setAttr ".tg[0].tor" -type "double3" -8.7633054129711047e-013 -88.263032023026227 
		-179.99999999999915 ;
	setAttr ".lr" -type "double3" -180.00000000013486 -91.736967976973716 180.00000000014182 ;
...
createNode parentConstraint -n "LeftClavicleJntGDLoc_parentConstraint1" -p "LeftClavicleJntGDLoc";
	...
	setAttr ".lr" -type "double3" 0.070887153505861528 5.9972518404760313 -89.942703004064654 ;
...
createNode parentConstraint -n "LeftShoulderJntGDLoc_parentConstraint1" -p "LeftShoulderJntGDLoc";
	...
	setAttr ".lr" -type "double3" 0.070887153505867551 5.9972518404760624 -89.942703004064626 ;
...
createNode parentConstraint -n "LeftElbowJntGDLoc_parentConstraint1" -p "LeftElbowJntGDLoc";
	...
	setAttr ".lr" -type "double3" 0.070881008572678816 -15.323961110182367 -89.942672182839701 ;
...
createNode parentConstraint -n "LeftWristJntGDLoc_parentConstraint1" -p "LeftWristJntGDLoc";
	...
	setAttr ".lr" -type "double3" -16.326895842138182 -89.017248869418978 16.452876834594999 ;
...
createNode parentConstraint -n "LeftThumb1JntGDLoc_parentConstraint1" -p "LeftThumb1JntGDLoc";
	...
	setAttr ".lr" -type "double3" -16.326895842137745 -89.017248869419049 16.452876834590995 ;
...
createNode parentConstraint -n "LeftThumb2JntGDLoc_parentConstraint1" -p "LeftThumb2JntGDLoc";
	...
	setAttr ".lr" -type "double3" -16.326895842138054 -89.017248869419021 16.452876834593937 ;
...
createNode parentConstraint -n "LeftIndex1JntGDLoc_parentConstraint1" -p "LeftIndex1JntGDLoc";
	...
	setAttr ".lr" -type "double3" -16.326895842137635 -89.017248869419035 16.452876834590885 ;
...
createNode parentConstraint -n "LeftIndex2JntGDLoc_parentConstraint1" -p "LeftIndex2JntGDLoc";
	...
	setAttr ".tg[0].tor" -type "double3" -8.1625309525935794e-015 38.802922552545446 
		0 ;
	setAttr ".lr" -type "double3" -16.326895842137091 -89.017248869419006 16.452876834592963 ;
...
createNode parentConstraint -n "LeftIndex3JntGDLoc_parentConstraint1" -p "LeftIndex3JntGDLoc";
	...
	setAttr ".tg[0].tor" -type "double3" -4.0812654762967897e-015 38.802922552545454 
		0 ;
	setAttr ".lr" -type "double3" -16.326895842137095 -89.017248869419006 16.452876834592963 ;
...
createNode parentConstraint -n "LeftIndex4JntGDLoc_parentConstraint1" -p "LeftIndex4JntGDLoc";
	...
	setAttr ".lr" -type "double3" -16.326895842136881 -89.017248869418992 16.452876834592754 ;
...
createNode parentConstraint -n "LeftMiddle2JntGDLoc_parentConstraint1" -p "LeftMiddle2JntGDLoc";
	...
	setAttr ".lr" -type "double3" -16.326895842137297 -89.017248869418992 16.452876834593187 ;
...
createNode parentConstraint -n "LeftMiddle3JntGDLoc_parentConstraint1" -p "LeftMiddle3JntGDLoc";
	...
	setAttr ".lr" -type "double3" -16.326895842137294 -89.017248869418992 16.452876834593187 ;
...
createNode parentConstraint -n "LeftRing2JntGDLoc_parentConstraint1" -p "LeftRing2JntGDLoc";
	...
	setAttr ".tg[0].tot" -type "double3" -4.4408920985006262e-016 0 0 ;
	setAttr ".tg[0].tor" -type "double3" -6.3611093629270335e-015 0 0 ;
	setAttr ".lr" -type "double3" -16.326895842137599 -89.017248869419006 16.45287683459329 ;
...
createNode parentConstraint -n "LeftPinky2JntGDLoc_parentConstraint1" -p "LeftPinky2JntGDLoc";
	...
	setAttr ".lr" -type "double3" -16.326895842137674 -89.017248869419021 16.452876834593557 ;
...
createNode parentConstraint -n "LeftPinky3JntGDLoc_parentConstraint1" -p "LeftPinky3JntGDLoc";
	...
	setAttr ".lr" -type "double3" -16.326895842137461 -89.017248869419006 16.452876834593344 ;
...
createNode parentConstraint -n "LeftHipJntGDLoc_parentConstraint1" -p "LeftHipJntGDLoc";
	...
	setAttr ".lr" -type "double3" -20.612387549665531 -2.2530014009314671e-014 -2.3333559292254402e-014 ;
...
createNode parentConstraint -n "LeftKneeJntGDLoc_parentConstraint1" -p "LeftKneeJntGDLoc";
	...
	setAttr ".tg[0].tor" -type "double3" 2.8937105468568413e-032 1.2850656302884472e-047 
		89.999999999999972 ;
	setAttr ".lr" -type "double3" 17.587257152962117 9.5683914675945783e-015 -2.0243926750412321e-014 ;
...
createNode parentConstraint -n "LeftAnkleScaleFixJntGDLoc_parentConstraint1" -p "LeftAnkleScaleFixJntGDLoc";
	...
	setAttr ".tg[0].tor" -type "double3" -1.3032113740542545e-016 -5.7874210937136826e-032 
		89.999999999999972 ;
	setAttr ".lr" -type "double3" 17.587257152962103 9.2037187477140395e-015 -1.7886550379661165e-014 ;
...
createNode parentConstraint -n "LeftBallJntGDLoc_parentConstraint1" -p "LeftBallJntGDLoc";
	...
	setAttr ".lr" -type "double3" 1.2600209776924802e-011 -1.4322997268987384e-005 359.9999495240798 ;
...
createNode parentConstraint -n "LeftFootOutJntGDLoc_parentConstraint1" -p "LeftFootOutJntGDLoc";
	...
	setAttr ".lr" -type "double3" 3.5805124337809841e-012 -1.4322997278532882e-005 -5.0475920233563349e-005 ;
...
createNode parentConstraint -n "LeftToeJntGDLoc_parentConstraint1" -p "LeftToeJntGDLoc";
	...
	setAttr ".lr" -type "double3" 3.5805124242399517e-012 -1.4322997278532882e-005 -5.0475920195396695e-005 ;
...
createNode parentConstraint -n "nurbsPlane2_parentConstraint1" -p "nurbsPlane2";
	...
	setAttr ".tg[0].tor" -type "double3" 2.3000605464089273e-014 89.999999552545461 
		0 ;
	setAttr ".lr" -type "double3" -0.34990409285814289 -37.859277828569006 0.3430010059655248 ;
...
createNode parentConstraint -n "nurbsPlane3_parentConstraint1" -p "nurbsPlane3";
	...
	setAttr ".tg[0].tor" -type "double3" 1.3959389827605066e-014 89.999999867187668 
		0 ;
	setAttr ".lr" -type "double3" -0.29044259565120417 -17.981739641174737 0.21791908092696627 ;
...
createNode parentConstraint -n "nurbsPlane4_parentConstraint1" -p "nurbsPlane4";
	...
	setAttr ".tg[0].tor" -type "double3" -1.4096913239397696e-030 89.999999999999986 
		0 ;
	setAttr ".lr" -type "double3" -0.27629323053387989 0.94311649868100766 0.12370697598074619 ;
...
createNode parentConstraint -n "nurbsPlane5_parentConstraint1" -p "nurbsPlane5";
	...
	setAttr ".tg[0].tor" -type "double3" 2.6190268817835087e-014 89.999999692767787 
		0 ;
	setAttr ".lr" -type "double3" -0.314044403201861 28.397160399414471 -0.021099859798961708 ;
...
createNode decomposeMatrix -n "ClavicleJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.60666480709464132 2.1323151953963229 1.7821786880118773 ;
	setAttr ".or" -type "double3" 179.92911284649415 5.9972518404760313 -90.057296995935346 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "ShoulderJntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "ShoulderJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.60690992265486454 1.8871634896640521 1.7561761968012093 ;
	setAttr ".or" -type "double3" 179.92911284649415 5.9972518404760615 -90.057296995935388 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "ElbowJntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "ElbowJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.60772650423486452 1.0704614939829249 1.6695511154011002 ;
	setAttr ".or" -type "double3" 179.92911899142732 -15.323961110182367 -90.057327817160299 ;
...
createNode decomposeMatrix -n "WristJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.60880086945405465 -0.0034616365720918671 1.9829102497458069 ;
	setAttr ".or" -type "double3" -163.67310415786187 -89.017248869418978 163.547123165405 ;
...
createNode decomposeMatrix -n "Thumb1JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.37593754418144465 -0.0037770733894184312 2.0255973277137151 ;
	setAttr ".or" -type "double3" -163.67310415786224 -89.017248869419049 163.54712316540898 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -0.99999999999999989 ;
createNode multMatrix -n "Thumb2JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Thumb2JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.18794168073053513 -0.0041554658154287355 2.0343974489283414 ;
	setAttr ".or" -type "double3" -163.67310415786181 -89.017248869419021 163.54712316540591 ;
...
createNode decomposeMatrix -n "Thumb3JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" 5.4182720374403755e-005 -0.0045338582414399305 2.0431975701429672 ;
	setAttr ".or" -type "double3" -163.67310415786181 -89.017248869419021 163.54712316540591 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -1 ;
createNode multMatrix -n "Thumb4JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Thumb4JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" 0.18805004617128379 -0.0049122506674502322 2.0519976913575939 ;
	setAttr ".or" -type "double3" -163.67310415786181 -89.017248869419021 163.54712316540591 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -1 ;
createNode multMatrix -n "Thumb5JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Thumb5JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" 0.37604590962219353 -0.0052906430934596509 2.0607978125722197 ;
	setAttr ".or" -type "double3" -163.67310415786181 -89.017248869419021 163.54712316540591 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -1 ;
createNode multMatrix -n "Index1JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Index1JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.40185582156948735 -0.0029148551217231008 2.192387845804991 ;
	setAttr ".or" -type "double3" -163.67310415786255 -89.017248869419035 163.54712316540929 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -0.99999999999999989 ;
createNode multMatrix -n "Index2JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Index2JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.2863489805511566 -0.0024569851073802827 2.3409744872701288 ;
	setAttr ".or" -type "double3" -163.67310415786284 -89.017248869419006 163.54712316540696 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "Index3JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Index3JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.1708421395328264 -0.0019991150930374663 2.4895611287352657 ;
	setAttr ".or" -type "double3" -163.67310415786284 -89.017248869419006 163.54712316540696 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "Index4JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Index4JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.055335298514495125 -0.0015412450786946507 2.638147770200403 ;
	setAttr ".or" -type "double3" -163.67310415786287 -89.017248869419006 163.54712316540696 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "Index5JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Index5JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" 0.060171542503834906 -0.0010833750643509451 2.7867344116655404 ;
	setAttr ".or" -type "double3" -163.67310415786284 -89.017248869419006 163.54712316540696 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "Middle1JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Middle1JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.5062770622509406 -0.0026893994931303264 2.1906688619513597 ;
	setAttr ".or" -type "double3" -163.67310415786255 -89.017248869419035 163.54712316540929 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -0.99999999999999989 ;
createNode multMatrix -n "Middle2JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Middle2JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.44817400188434492 -0.0019563570049963169 2.3696759205094495 ;
	setAttr ".or" -type "double3" -163.67310415786261 -89.017248869419006 163.5471231654067 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "Middle3JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Middle3JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.39007094151774935 -0.001223314516860528 2.5486829790675398 ;
	setAttr ".or" -type "double3" -163.67310415786261 -89.017248869419006 163.5471231654067 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "Middle4JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Middle4JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.33196788115115328 -0.000490272028725625 2.727690037625631 ;
	setAttr ".or" -type "double3" -163.67310415786261 -89.017248869419006 163.5471231654067 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "Middle5JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Middle5JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.27386482078455776 0.00024277045940927365 2.9066970961837209 ;
	setAttr ".or" -type "double3" -163.67310415786261 -89.017248869419006 163.5471231654067 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "Ring1JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Ring1JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.61219013120526811 -0.0024607228620013668 2.1889253196008487 ;
	setAttr ".or" -type "double3" -163.67310415786255 -89.017248869419035 163.54712316540929 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -0.99999999999999989 ;
createNode multMatrix -n "Ring2JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Ring2JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.61528588700478382 -0.0015464870636860205 2.3770997345934499 ;
	setAttr ".or" -type "double3" -163.67310415786241 -89.017248869419006 163.5471231654067 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -1 ;
createNode multMatrix -n "Ring3JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Ring3JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.61838164280429953 -0.00063225126537066762 2.5652741495860525 ;
	setAttr ".or" -type "double3" -163.67310415786241 -89.017248869419006 163.5471231654067 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -1 ;
createNode multMatrix -n "Ring4JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Ring4JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.62147739860381523 0.00028198453294468311 2.7534485645786546 ;
	setAttr ".or" -type "double3" -163.67310415786241 -89.017248869419006 163.5471231654067 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -1 ;
createNode multMatrix -n "Ring5JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Ring5JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.62457315440333094 0.0011962203312591456 2.9416229795712567 ;
	setAttr ".or" -type "double3" -163.67310415786241 -89.017248869419006 163.5471231654067 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -1 ;
createNode multMatrix -n "Pinky1JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Pinky1JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.71911853962469141 -0.0022308339325439663 2.186961828555579 ;
	setAttr ".or" -type "double3" -163.67310415786224 -89.017248869419049 163.54712316540898 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -0.99999999999999989 ;
createNode multMatrix -n "Pinky2JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Pinky2JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.80862283931113044 -0.0012322438777087211 2.3525154849465379 ;
	setAttr ".or" -type "double3" -163.67310415786253 -89.017248869419006 163.54712316540662 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -1 ;
createNode multMatrix -n "Pinky3JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Pinky3JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.89812713899756969 -0.0002336538228743617 2.5180691413374974 ;
	setAttr ".or" -type "double3" -163.67310415786261 -89.017248869419006 163.5471231654067 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "Pinky4JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Pinky4JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.98763143868400827 0.00076493623195999063 2.6836227977284555 ;
	setAttr ".or" -type "double3" -163.67310415786253 -89.017248869419006 163.54712316540662 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -1 ;
createNode multMatrix -n "Pinky5JntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "Pinky5JntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -1.0771357383704474 0.0017635262867943524 2.8491764541194153 ;
	setAttr ".or" -type "double3" -163.67310415786253 -89.017248869419006 163.54712316540662 ;
	setAttr ".os" -type "double3" 0.99999999999999989 1 -1 ;
createNode multMatrix -n "HipJntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "HipJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.5687235565635973 2.2782081787757664 -0.050313589899389832 ;
	setAttr ".or" -type "double3" 20.612387549665534 180 0 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "KneeJntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "KneeJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.56872355656359697 1.0592091928569627 0.432627143433233 ;
	setAttr ".or" -type "double3" 162.41274284703789 0 180 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "AnkleScaleFixJntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "AnkleScaleFixJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.56872355656359674 0.25044961176408131 0.17627145017438467 ;
	setAttr ".or" -type "double3" 162.41274284703789 0 180 ;
	setAttr ".os" -type "double3" 1 0.99999999999999989 -0.99999999999999989 ;
createNode multMatrix -n "BallJntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "BallJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.56872387917156264 -0.0041892558406921854 0.28151880496228698 ;
	setAttr ".or" -type "double3" 0 180.00001432299726 5.0475920182017152e-005 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "FootOutJntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "FootOutJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.73145990270133587 -0.0041893585250409888 -0.064173899639995993 ;
	setAttr ".or" -type "double3" 0 180.00001432299726 5.0475920232906031e-005 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "ToeJntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "ToeJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.56872379722829891 -0.0041892558406920032 0.6093135463385424 ;
	setAttr ".or" -type "double3" 0 180.00001432299726 5.0475920182017152e-005 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "FootInJntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "FootInJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.42221647839914278 -0.0041891633962934591 -0.064173976945737565 ;
	setAttr ".or" -type "double3" 0 180.00001432299726 5.0475920232906031e-005 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
createNode multMatrix -n "HeelJntGDMultMatrix";
	setAttr -s 2 ".i";
createNode decomposeMatrix -n "HeelJntGDDecomposeMatrix";
	setAttr ".ot" -type "double3" -0.56872396733364949 -0.0041892558406576913 -0.29185121263719449 ;
	setAttr ".or" -type "double3" 0 180.00001432299726 5.0475920232906031e-005 ;
	setAttr ".os" -type "double3" 1 1 -1 ;
